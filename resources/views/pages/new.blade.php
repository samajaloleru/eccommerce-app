                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="card card-blog">
                      <div class="card-image">
                        <a href="#pablo">
                          <img class="img img-raised" src="./frontend/img/sections/miguel-perales.jpg" />
                        </a>
                      </div>
                      <div class="card-body">
                        <h6 class="card-category text-info">Enterprise</h6>
                        ...
                        <div class="card-footer">
                          <div class="author">
                            <a href="#pablo">
                              <img src="./frontend/img/faces/ayo-ogunseinde-2.jpg" alt="..." class="avatar img-raised">
                              <span>Mike John</span>
                            </a>
                          </div>
                          <div class="stats">
                  ...
                  <div class="col-md-4">
                    <div class="card card-blog">
                      <div class="card-image">
                        <a href="#pablo">
                          <img class="img img-raised" src="./frontend/img/sections/roger-keller.jpg" />
                        </a>
                      </div>
                      <div class="card-body">
                        ...
                        <div class="card-footer">
                          <div class="author">
                            <a href="#pablo">
                              <img src="./frontend/img/faces/kaci-baum-2.jpg" alt="..." class="avatar img-raised">
                  ...
                  <div class="col-md-4">
                    <div class="card card-blog">
                      <div class="card-image">
                        <a href="#pablo">
                          <img class="img img-raised" src="./frontend/img/sections/joshua-earlesz.jpg" />
                        </a>
                      </div>
                      <div class="card-body">
                        <h6 class="card-category text-danger">
                        ...
                        <div class="card-footer">
                          <div class="author">
                            <a href="#pablo">
                              <img src="./frontend/img/faces/erik-lucatero-2.jpg" alt="..." class="avatar img-raised">
                              <span>Mike John</span>
                            </a>
                          </div>
                          <div class="stats">
              ...
              <div class="col-md-10 ml-auto mr-auto">
                ...
                <div class="card card-plain card-blog">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card-image">
                        <img class="img" src="./frontend/img/sections/jeff-sheldon.jpg" />
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
                ...
                <div class="card card-plain card-blog">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="card-image">
                        <a href="#pablo">
                          <img class="img" src="./frontend/img/sections/rawpixel-comm.jpg" />
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-plain card-blog">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card-image">
                        <a href="#pablo">
                          <img class="img" src="./frontend/img/sections/jeremy-yap.jpg" />
                        </a>
                      </div>
                    </div>
                    <div class="col-md-8">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card card-plain card-blog text-center">
                  <div class="card-image">
                    <a href="#pablo">
                      <img class="img img-raised" src="./frontend/img/sections/val-vesa.jpg" />
                    </a>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="card card-plain card-blog text-center">
                  <div class="card-image">
                    <a href="#pablo">
                      <img class="img img-raised" src="./frontend/img/sections/rodrigo-ardilha.jpg" />
                    </a>
                  </div>
                  <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card card-plain card-blog text-center">
                  <div class="card-image">
                    <a href="#pablo">
                      <img class="img img-raised" src="./frontend/img/sections/federico-beccari.jpg" />
                    </a>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="card card-plain card-blog text-center">
                  <div class="card-image">
                    <a href="#pablo">
                      <img class="img img-raised" src="./frontend/img/sections/pedro-lastra.jpg" />
                    </a>
                  </div>
                  <div class="card-body">
