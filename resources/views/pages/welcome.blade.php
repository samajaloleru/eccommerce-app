                                        ...
                                        <div class="col-md-3 col-lg-2 col-sm-4 col-6">
                                            <div class="card">
                                                <div class="card-image">
                                                    <a href="">
                                                        <img src="/storage/image/{{$v_product->image}}" href="{{URL::to('/view_product/'.$v_product->product_id)}}" style="height:200px; width:100%" class="img-rounded img-responsive">
                                                    </a>
                                                </div>
                                                <div class="card-body px-1">
                                                    <div class="card-description text-height text-center">
                                                        <div class="p-title font-weight-bold">{{$v_product->product_name}}</div>
                                                    
                                                        <div class="pt-3 p-sub">₦ {{$v_product->price}}</div>
                                                    </div>
