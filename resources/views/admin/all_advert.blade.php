                                        ...
                                        <div class="card-icon">
                                            ...
                                            <a class="material-icons">
                                                <h3 class="font-weight-bold">
                                                    {{$count = count($advert_slider)}}
                                                </h3>
                                            </a>
                                        </div>
                                        <h4 class="header font-weight-bold">Advert Table</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <img src="{{URL::to($v_slider->advert_image)}}" alt="" style="height:70px; width:450px">
                                                        </td>
                                                        <td class="">
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            @endif
                                                            <a href="{{URL::to('/delete-advert/'.$v_slider->advert_id)}}" rel="tooltip" class="btn btn-danger">
