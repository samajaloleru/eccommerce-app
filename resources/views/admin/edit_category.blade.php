                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <div class="card-body">
                                <form action = "/edit-category/<?php echo $category[0]->category_id; ?>" method="post">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                <label>Category Name</label>
                                                <input type="text" class="form-control" placeholder="Category Name" name="category_name" value = '<?php echo$category[0]->category_name; ?>'>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-3">
                                            <div class="form-group">
                                                <label>Published Status</label>
                                                <input type="checkbox" class=" ml-3" name="status" value = '<?php echo$category[0]->status; ?>'>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control textarea" name="description" value = '<?php echo$category[0]->description; ?>' ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
