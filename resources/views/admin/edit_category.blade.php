                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox" name="status" value = '<?php echo$category[0]->status; ?>'> Published Status
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="description" value = '<?php echo$category[0]->description; ?>'>
                                                    </div>
                                                </div>
                                            </div>
