                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-rose card-header-icon">
                                        ...
                                        <h4 class="header font-weight-bold">Category Table</h4>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            @endif
                                                            <a href="{{URL::to('/edit-category/'.$v_category->category_id)}}" rel="tooltip" class="btn btn-success">
                                                                <i class="material-icons">edit</i>
                                                            </a>
                                                            <a href="{{URL::to('/delete-category/'.$v_category->category_id)}}" rel="tooltip" class="btn btn-danger">
