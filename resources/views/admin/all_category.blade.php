                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title float-left">Category Table</h4>
                                    <h2 class="card-title float-right"><sup class="pr-2">Total Number of Category</sup>{{$count = count($category)}}</h2>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach( $category as $v_category)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        @if($v_category->status==1)
                                                        <a  href="{{URL::to('/unactive-category/'.$v_category->category_id)}}" class="btn btn-danger btn-link btn-sm">
                                                            Deactivate
                                                        </a>
                                                        @else
                                                        <a  href="{{URL::to('/active-category/'.$v_category->category_id)}}" class="btn btn-success btn-link btn-sm">
                                                            Activate
                                                        </a>
                                                        @endif
                                                        <a  href="{{URL::to('/edit-category/'.$v_category->category_id)}}" class="btn btn-success btn-link btn-sm">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a href="{{URL::to('/delete-category/'.$v_category->category_id)}}" class="btn btn-danger btn-link btn-sm">
